...
type Querier interface {
	...
	CountItemPhotos(ctx context.Context, itemID string) (int64, error)
	...
	CreateHomePhoto(ctx context.Context, arg CreateHomePhotoParams) (CreateHomePhotoRow, error)
	...
	GetHomePhotoFilePath(ctx context.Context, arg GetHomePhotoFilePathParams) (GetHomePhotoFilePathRow, error)
