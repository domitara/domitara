  ...
  return (
    <Stack gap={14}>
      ...
      <Group gap={4} style={{ fontSize: 13, color: 'var(--dt-fg-3)' }}>
        ...
        <span>/</span>
        <span style={{ color: 'var(--dt-fg-1)', fontWeight: 500 }}>Edit</span>
      </Group>
      ...
      <Group justify="space-between" align="flex-start">
        ...
        <Group gap={8}>
          ...
          <Button onClick={handleSubmit} loading={updateItem.isPending}>
            Save changes
          </Button>
        </Group>
      </Group>
      ...
      <Paper withBorder p={20} radius="md">
        ...
        <Stack gap={14}>
          ...
          <TextInput
            ...
            description="Clear this field to remove the asset ID"
          />
          <div>
